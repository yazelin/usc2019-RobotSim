...
public class Gripper : MonoBehaviour
{
	...
	// 1.use OnTriggerEnter to catch objects within a default range，the parent of 夾取指令時將該物件的parent設為Gripper
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYwNDYxNjk5NCwtOTAyMjY5OTUxLDQ0Mz
